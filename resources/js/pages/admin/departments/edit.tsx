                    ...
                    <Card className="border-none shadow-md ring-1 ring-gray-200">
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle>Edit Departemen</CardTitle>
                                    <CardDescription>Perbarui informasi unit departemen atau program studi.</CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            <SelectTrigger id="faculty_id" className={errors.faculty_id ? 'border-red-500 ring-red-100' : ''}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder="teknik-informatika"
                                            className={`bg-gray-50 font-mono text-xs ${errors.slug ? 'border-red-500 ring-red-100' : ''}`}
                                        />
                                ...
                                <div className="flex items-center justify-end gap-3 pt-4 border-t mt-6 pt-6">
