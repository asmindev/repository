                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {featuredWorks.map((work) => (
                                <Link key={work.id} href={route('works.show', work.id)} className="group">
                                    <div className="flex flex-col h-full rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/50 hover:shadow-sm">
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1 flex flex-col min-w-0">
                                                <div className="mb-2 inline-block self-start rounded bg-primary/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-primary">
                                        ...
                                        <div className="mt-auto pt-4 flex items-center justify-between border-t border-border/40 text-[10px] font-medium text-muted-foreground/80">
                                            <div className="flex items-center gap-3">
                                                <span className="flex items-center gap-1"><Eye className="h-3.5 w-3.5" /> {work.view_count || 0}</span>
                                                <span className="flex items-center gap-1"><Download className="h-3.5 w-3.5" /> {work.download_count || 0}</span>
                                            </div>
                                            <span className="flex items-center gap-1"><Calendar className="h-3.5 w-3.5" /> {work.year}</span>
                                        </div>
                                    </div>
                                </Link>
                            ))}
